...
export class AddNewNotes extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.querySelector('#formAddNotes').addEventListener('submit', event => {
      let titleNotes = this.querySelector('#formAddNotes').titleNotes.value;
      let bodyNotes = this.querySelector('#formAddNotes').bodyNotes.value;
